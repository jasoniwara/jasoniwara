...
import { ARCHIVABLE_SECTIONS } from '@/lib/sections';
...
export async function getContent() {
  ...
  return {
    ...
    nav: defaults.nav,
    sectionLabels: { ...defaults.sectionLabels, ...overrides.sectionLabels },
    ...
    archive: Object.fromEntries(
      ARCHIVABLE_SECTIONS.map((key) => [key, (overrides.archive && overrides.archive[key]) || defaults.archive[key] || []])
    ),
  };
}
